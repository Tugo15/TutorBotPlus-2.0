                                                ...
                                                <div class="d-flex px-3 py-1 justify-content-center align-items-center gap-1">
                                                    @can('editar categoría de problema')
                                                        <a class="btn btn-xs btn-outline-info mb-0" title="Editar Categoría"
                                                            href="{{ route('categorias.editar', ['id' => $categoria->id]) }}"><i class="fa fa-pencil me-1"></i> Editar</a>
                                                    @endcan
                                                    @can('eliminar categoría de problema')
                                                        <form action="{{ route('categorias.eliminar', ['id' => $categoria->id]) }}"
                                                            ...
                                                            @csrf
                                                            <button type="submit" class="btn btn-xs btn-outline-danger mb-0" title="Eliminar Categoría"><i class="fa fa-fw fa-trash me-1"></i> Eliminar</button>
                                                        </form>
                                                    @endcan
                                                </div>
                                            </td>
